/**
 * @public
 * Used to provide additional parameters to custom message/conversation action events.
 */
...
export declare interface ConversationBuilder {
     ...
     * did not have the appropriate permissions (as defined in their Role in the
 ...
 * custom action as defined in the dashboard.
 */
...
export declare interface SessionOptions {
    ...
    /**
     * If you use
     * {@link https://talkjs.com/docs/Features/Security_Settings/Identity_Verification | Identity verification}
...
export declare interface UIBox {
     ...
     *
     * @remarks
     * To set up a custom action, you need to create it in the role editor. If an
     * action is allowed on a particular conversation, it'll show up in that
